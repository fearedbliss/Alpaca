...
void Install_LoadPlayerData()
{
	...
	DWORD LoadSinglePlayerCustomDataOffset = D2Game::GetAddress(0x5046F);
	DWORD LoadMultiPlayerCustomDataOffset = D2Game::GetAddress(0x50790);
	DWORD SendSaveFilesToServerOffset = D2Client::GetAddress(0xCF42);
	DWORD ReceiveSaveFilesFromClientOffset = D2Game::GetAddress(0x183A);
	DWORD BugFix109bOffset = Fog::GetAddress(0x47DE);
	...
	Memory::ChangeCallA(0x1D74003F, (DWORD)caller_LoadMPPlayerCustomData_9);

	// Send save files to Server.
	Memory::SetCursor(SendSaveFilesToServerOffset);
	Memory::ChangeCallB((DWORD)Fog::D2FogGetSavePath, (DWORD)caller_SendSaveFiles);
	...
	Memory::SetCursor(BugFix109bOffset);
	Memory::ChangeByte(0x8B, 0xE8);
	Memory::ChangeCallA(0x891C2444, (DWORD)caller_BugFix109b);
	Memory::ChangeByte(0x44, 0x90);
	Memory::ChangeByte(0x24, 0x90);
	Memory::ChangeByte(0x20, 0x90);
