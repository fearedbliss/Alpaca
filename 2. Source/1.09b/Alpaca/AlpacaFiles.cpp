...
void Install_AlpacaFiles()
{
	...
	DWORD FindCustomFileOffset = Storm::GetAddress(0x192C6);
	...
	Memory::ChangeCallD((DWORD)LeaveCriticalSection, (DWORD)caller_isModFile_9);
...
void Install_AlpacaImagesFiles()
{
	...
	DWORD LoadCustomImageOffset = D2Client::GetAddress(0x57E21);
	DWORD FreeCustomImageOffset = D2Client::GetAddress(0x57FA9);
